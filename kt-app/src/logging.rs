...
pub fn setup_logging() -> Result<(), fern::InitError> {
    ...
    let kt_trace = std::env::var("KT_TRACE").is_ok();
    let kt_debug = std::env::var("KT_DEBUG").is_ok();
    ...
    let module_logging_level = if kt_debug || kt_trace {
        LevelFilter::Info
    } else {
        LevelFilter::Error
    };
    ...
    let base_config = fern::Dispatch::new()
        ...
        .level_for("kt_app", LevelFilter::Debug)
        .level_for("kt_app_lib", logging_level);
