...
div
  ...
  p
    ...
    | You can also find and share categorization rule presets on #[a(href="https://forum.komutracker.net/c/projects/category-rules") the forum].
...
export default {
  ...
  methods: {
    ...
    exportClasses: function () {
      ...
      const filename = 'kt-category-export.json';
