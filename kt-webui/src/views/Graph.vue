...
div
  ...
  b-alert(show variant="warning")
    | This feature is still in early development. See PR #[a(href="https://github.com/ncc-sg/kt-webui/pull/365") kt-webui#365] for more information.
  ...
  div(v-show="show_options")
    h4 Options
    kt-query-options(v-model="queryOptions")
...
import { getClient } from '~/util/ktclient';

export default {
  name: 'Graph',
  components: {
    'kt-force-graph': () => import('~/visualizations/ForceGraph.vue'),
  },
  data() {
    return {
  ...
  methods: {
    ...
    fetchEvents: async function () {
      ...
      let query = canonicalEvents({
        bid_window: 'kt-watcher-window_' + this.queryOptions.hostname,
        bid_afk: 'kt-watcher-afk_' + this.queryOptions.hostname,
