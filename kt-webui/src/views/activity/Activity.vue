...
div
  ...
  div.row(v-if="showOptions" style="background-color: #EEE;").my-3.py-3
    ...
    div.col-md-6
      ...
      b-form-checkbox(v-if="devmode" v-model="include_stopwatch" size="sm")
        // WIP: https://github.com/ncc-sg/kt-webui/pull/368
        | Include manually logged events (stopwatch)
        br
        | #[b Note:] WIP, breaks kt-server-rust badly. Only shown in devmode.
  ...
  kt-periodusage.mt-2(:periodusage_arr="periodusage", @update="setDate")

  kt-uncategorized-notification()
...
export default {
  name: 'Activity',
  components: {
    'kt-uncategorized-notification': () => import('~/components/UncategorizedNotification.vue'),
  },
  props: {
    host: String,
    date: {
  ...
  computed: {
    ...
    periodReadableRange: function () {
      ...
      // worth the tradeoff. https://github.com/ncc-sg/kt-webui/pull/284
