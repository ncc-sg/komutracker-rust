...
function get_params(
  ...
  const new_params: DesktopQueryParams = {
    ...params,
    bid_window: 'kt-watcher-window_' + host,
    bid_afk: 'kt-watcher-afk_' + host,
    bid_browsers: [],
...
const browser_appnames = {
  ...
  firefox: [
    ...
    // Pre-releases https://github.com/ncc-sg/kt-watcher-web/issues/87
    'Firefox-esr',
    'Firefox Beta',
    'Nightly',
    'firefox-aurora',
  ...
  edge: [
    ...
    'Microsoft-Edge-Stable', // Arch Linux: https://github.com/ncc-sg/komutracker-rust/issues/753
    'Microsoft-edge',
