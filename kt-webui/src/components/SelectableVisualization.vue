...
div
  ...
  div(v-if="activityStore.buckets.loaded")
    ...
    div(v-if="type == 'category_tree'")
      kt-categorytree(:events="activityStore.category.top")
    div(v-if="type == 'category_sunburst'")
      kt-sunburst-categories(:data="top_categories_hierarchy", style="height: 20em")
    div(v-if="type == 'timeline_barchart'")
      kt-timeline-barchart(:datasets="datasets", :timeperiod_start="activityStore.query_options.timeperiod.start", :timeperiod_length="activityStore.query_options.timeperiod.length", style="height: 100")
    div(v-if="type == 'sunburst_clock'")
      kt-sunburst-clock(:date="date", :afkBucketId="activityStore.buckets.afk[0]", :windowBucketId="activityStore.buckets.window[0]")
    div(v-if="type == 'custom_vis'")
      kt-custom-vis(:visname="props.visname" :title="props.title")
