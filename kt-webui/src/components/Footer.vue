...
div.container(style="color: #555; font-size: 0.9em")
  ...
  div(style="font-size: 0.9em; opacity: 0.8; fill: #88F")
    div.float-none.float-md-right.my-2
      a(href="https://github.com/ncc-sg/komutracker-rust/issues/new/choose", target="_blank").mr-3
        icon(name="bug")
        | Report a bug
    ...
    div.float-none.float-md-left.my-2
      a(href="https://twitter.com/KomuTrackerIt", target="_blank")
        icon(name="brands/twitter")
        | Twitter
      a(href="https://github.com/ncc-sg/komutracker-rust", target="_blank").ml-3
