...
struct Opts {
    ...
    /// Don't import from kt-server-python if no kt-server-rust db found
    #[clap(long)]
...
async fn main() -> Result<(), rocket::Error> {
    ...
    logging::setup_logger("kt-server-rust", testing, opts.verbose)
    ...
    info!("Using kt-webui assets at path {:?}", asset_path);
