...
//! BadRequest
//!
//! [1]: https://github.com/ncc-sg/komutracker-rust/security/advisories/GHSA-v9fg-6g9j-h4x4
...
impl HostCheck {
    pub fn new(config: &KTConfig) -> HostCheck {
...
mod tests {
    ...
    fn setup_testserver(address: String) -> Rocket<rocket::Build> {
        ...
        let mut kt_config = KTConfig::default();
        kt_config.address = address;
        endpoints::build_rocket(state, kt_config)
    }
