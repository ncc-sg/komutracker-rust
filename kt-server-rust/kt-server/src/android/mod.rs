...
pub mod android {
    ...
    #[no_mangle]
    pub unsafe extern "C" fn Java_net_komutracker_android_RustInterface_greeting(
        env: JNIEnv,
        _: JClass,
    ...
    #[no_mangle]
    pub unsafe extern "C" fn Java_net_komutracker_android_RustInterface_startServer(
        env: JNIEnv,
        _: JClass,
    ) {
    ...
    async fn start_server() {
        ...
        unsafe {
            ...
            let mut server_config: KTConfig = KTConfig::default();
    ...
    #[no_mangle]
    pub unsafe extern "C" fn Java_net_komutracker_android_RustInterface_initialize(
        env: JNIEnv,
        _: JClass,
    ) {
        if !INITIALIZED {
            android_logger::init_once(
                Config::default()
                    ...
                    .with_tag("kt-server-rust"), // logs will show under mytag tag
                                                 //.with_filter( // configure messages for specific crate
                                                 //    FilterBuilder::new()
                                                 //        .parse("debug,hello::crate=error")
                                                 //        .build())
            );
            info!("Initializing kt-server-rust...");
            debug!("Redirected kt-server-rust stdout/stderr to logcat");
        } else {
    ...
    #[no_mangle]
    pub unsafe extern "C" fn Java_net_komutracker_android_RustInterface_setDataDir(
        env: JNIEnv,
        _: JClass,
        java_dir: JString,
    ) {
    ...
    #[no_mangle]
    pub unsafe extern "C" fn Java_net_komutracker_android_RustInterface_getBuckets(
        env: JNIEnv,
        _: JClass,
    ) -> jstring {
    ...
    #[no_mangle]
    pub unsafe extern "C" fn Java_net_komutracker_android_RustInterface_createBucket(
        env: JNIEnv,
        _: JClass,
        java_bucket: JString,
    ) -> jstring {
    ...
    #[no_mangle]
    pub unsafe extern "C" fn Java_net_komutracker_android_RustInterface_heartbeat(
        env: JNIEnv,
        _: JClass,
    ...
    #[no_mangle]
    pub unsafe extern "C" fn Java_net_komutracker_android_RustInterface_getEvents(
        env: JNIEnv,
        _: JClass,
        java_bucket_id: JString,
        java_limit: jint,
