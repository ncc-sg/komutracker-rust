...
pub fn create_config(testing: bool) -> KTConfig {
    set_testing(testing);
    ...
    if !config_path.is_file() {
        ...
        let default_config = KTConfig::default();
    ...
    let kt_config: KTConfig = toml::from_str(&content).expect("Failed to parse config file");
