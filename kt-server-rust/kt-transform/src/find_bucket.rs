...
mod tests {
    ...
    #[test]
    fn test_find_bucket() {
        let expected_bucketname = "kt-datastore-test_test-host".to_string();
        ...
        let res = find_bucket("kt-datastore-test", &Some("testhost".to_string()), &buckets);
        ...
        let res = find_bucket("kt-datastore-test", &None, &buckets);
        assert_eq!(res, None);
    }
}
