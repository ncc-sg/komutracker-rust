...
/// For example the events from kt-watcher-window should be called with filter_period_intersect
/// with the "not-afk" events from kt-watcher-afk to give events with durations of only when the
