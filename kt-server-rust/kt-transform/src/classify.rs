...
///
/// Based on code in kt_research: https://github.com/ncc-sg/kt-research/blob/master/kt_research/classify.py
use kt_models::Event;
...
/// for instance: "Work -> KomuTracker -> kt-server-rust"
...
fn test_rule_lookahead() {
    // Originally requested by a user here, to match kt-server-python: https://canary.discord.com/channels/755040852727955476/755334543891759194/994291987878522961
    let mut e_match = Event::default();
    e_match
        .data
