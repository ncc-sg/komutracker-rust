...
pub fn pull_all(client: &KtClient) -> Result<(), Box<dyn Error>> {
...
pub fn pull(host: &str, client: &KtClient) -> Result<(), Box<dyn Error>> {
...
pub fn push(client: &KtClient) -> Result<(), Box<dyn Error>> {
