 ...
 * 3: see: https://github.com/ncc-sg/kt-server-rust/pull/52
...
fn _migrate_v2_to_v3(conn: &Connection) {
    // For details about why this migration was necessary, see: https://github.com/ncc-sg/kt-server-rust/pull/52
...
impl DatastoreInstance {
    ...
    pub fn heartbeat(
        ...
        let inserted_heartbeat = match kt_transform::heartbeat(&last_event, &heartbeat, pulsetime) {
