//! Query building utilities for KomuTracker
//!
//! This module provides functionality to build canonical queries that are compatible
//! with the KomuTracker query language. It includes support for:
//!
...
//! ## Server-side Classes
//!
//! The queries can automatically fetch categorization classes from the KomuTracker server:
//!
//! ```rust
//! use kt_client_rust::queries::{DesktopQueryParams, QueryParams, QueryParamsBase};
//!
...
//!     },
//!     bid_window: "kt-watcher-window_example".to_string(),
//!     bid_afk: "kt-watcher-afk_example".to_string(),
...
mod tests {
    ...
    fn test_desktop_query_generation() {
        let params = DesktopQueryParams {
            ...
            bid_window: "kt-watcher-window_".to_string(),
            bid_afk: "kt-watcher-afk_".to_string(),
            always_active_pattern: None,
        };
