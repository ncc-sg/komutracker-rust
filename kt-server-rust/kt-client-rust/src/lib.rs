...
pub use kt_models::{Bucket, BucketMetadata, Event};
...
impl std::fmt::Debug for KtClient {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        write!(f, "KtClient(baseurl={:?})", self.baseurl)
    }
}
...
impl KtClient {
    ...
    pub async fn get_info(&self) -> Result<kt_models::Info, reqwest::Error> {
    ...
    pub async fn get_settings(&self) -> Result<kt_models::Settings, reqwest::Error> {
